package dz.currencyconverter.controllers;

import java.io.IOException;
import java.net.URL;
import java.util.List;
import java.util.ResourceBundle;
import java.util.logging.Level; // Provides standard logging levels to categorize log messages by severity
import java.util.logging.Logger; // Allows logging messages to be recorded and "optionally sent to various destinations
...
import javafx.scene.control.TableColumn; // Represents a column in a TableView control for displaying data
import javafx.scene.control.TableView; // Displays a collection of items in a table format with customizable columns
import javafx.scene.control.TextField; // Allows user input of single-line text in a JavaFX application
...
import dz.currencyconverter.repository.ConverterImp;
import dz.currencyconverter.services.CurrencyService;
import dz.currencyconverter.services.HistoricalCurrencyService;
...
public class DashboardController implements Initializable  {
    ...
    private void alertMessage() {
       Alert alert=new Alert(Alert.AlertType.ERROR); // Create a new error alert dialog"
       alert.setTitle("invalid data input"); // Set the title of the alert dialog
